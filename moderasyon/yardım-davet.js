...
.addField(`<:sagok:778774307253518366> __Davet Log__`,` \`${prefix}davet-log ayarla <#kanal>\` Davet Log Kanalını Ayarlarsınız.`,true)
.addField(`<:sagok:778774307253518366> __Davetlerim__`,` \`${prefix}davetlerim\` Davet Sayınızı Öğrenirsiniz.`,true)
