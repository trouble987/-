...
.addField(`<:sagok:778774307253518366> __İstatistiğim__`,` \`${prefix}istatistiğim\`Kendi istatistiğinizi görürsünüz.`,true)
.addField(`<:sagok:778774307253518366> __Sıralama__`,` \`${prefix}top\` Sunucududa istatistiklerde ilk 5i gösterir.`,true)
.addField(`<:sagok:778774307253518366> __Reset__`,` \`${prefix}reset\` Sunucudaki istatistikleri sıfırlar..`,true)
